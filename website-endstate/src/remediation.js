...
module.exports = buildAreaPage({
  ...
  intro: {
    ...
    body: [
      'Surplus, obsolete and recovered munitions are a liability for as long as they exist: to the people who guard them, to the communities near them, and to the nations accountable for them. Moving them to be destroyed somewhere else adds risk at every mile and every handoff.',
  ...
  why: {
    ...
    items: [
      ...
      { label: 'Custody', title: 'No transfers, no diversion windows', body: 'Munitions are destroyed where they are held, under the owner’s supervision, with an item-level record from intake to certificate.' },
