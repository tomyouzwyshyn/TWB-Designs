...
<section class="section" id="mission">
  <div class="wrap intro-split">
    <div class="rv">
      ...
      <h2 class="h2" style="margin-top:.4em">One solution for military and law enforcement organizations, after the mission.</h2>
    ...
    <div class="rv">
      ...
      <p class="lede">Military and law enforcement organizations should not need a different contractor for every step of that work. End State is the single solution. We find what is hidden, identify what is found, destroy it inside the owner’s custody, and return the metal it was made from to domestic supply. One partner, one record, from the first signal in the ground to the last certified kilogram.</p>
    </div>
  </div>
</section>
...
<section class="section" id="operators" style="padding-top:0">
  <div class="wrap">
    <div class="rv" style="max-width:640px">
      ...
      <h2 class="h2" style="margin-top:.4em">Built for military and law enforcement organizations.</h2>
    ...
    <div class="aud-grid rv">
      ...
      <div class="aud-card">
        ...
        <h3 class="h3">Law enforcement agencies</h3>
...
module.exports = { file: 'index.html', title: 'Detection, Identification and Remediation', description: 'End State Solutions is a full-service munitions processing and reclamation company operating since 2004, and the single solution for military and law enforcement organizations after the mission.', body, dark: true };
